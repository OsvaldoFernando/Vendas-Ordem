	...
	<div class="container-fluid">
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				...
				<!-- Botão -->
				<a title="Cadastrar novo fornecedor" href="<?php echo base_url('fornecedor/add'); ?>" class="btn btn-success btn-sm float-right"><i
							class="fas fa-user-tag"></i>&nbsp;Novo</a>
					...
					<table class="table table-bordered dataTable " width="100%" cellspacing="0">
						...
						<?php foreach ($fornecedores as $fornecedor): ?>
							...
							<tr>
								...
								<td> <?php echo $fornecedor->fornecedor_endereco ?></td>
								<td> <?php echo $fornecedor->fornecedor_bairro ?></td>
...
<!--***********************************************************************************************************************************-->
								<!-- Operações -->
								<td class="text-right">
									<a title="Editar" href="<?php echo base_url('fornecedores/edit/' . $fornecedor->fornecedor_id); ?>"
									   class="btn btn-sm btn-primary"><i class="fas fa-user-edit"></i></a>
									<a title="Excluir " href="javascript(void)" data-toggle="modal" data-target="#fornecedor-<?php echo $fornecedor->fornecedor_id;?>" class="btn btn-sm btn-danger"><i
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-footer">
											...
											<a class="btn btn-danger btn-sm" href="<?php echo base_url('fornecedor/del/' . $fornecedor->fornecedor_id) ;?>">Sim</a>
										</div>
									</div>
								</div>
							</div>
