			...
			<div class="card-body">
				...
				<form class="user" method="POST" name="form_edit">
					...
					<p><strong><i class="fas fa-clock"></i>&nbsp;&nbsp;Última
							alteração:&nbsp;
						</strong><?php echo formata_data_banco_com_hora($fornecedor->fornecedor_data_alteracao); ?></p>
						...
						<div class="form-group row mb-3">
							...
							<div class="col-md-6">
								...
								<input type="text" class="form-control form-control-user" name="fornecedor_razao"
									   value="<?php echo $fornecedor->fornecedor_razao; ?>">
								<?php echo form_error('fornecedor_razao', '<small class="form-text text-danger">', '</small>'); ?>
							</div>

							<div class="col-md-6">
								<label>Nome fantasia</label>
								<input type="text" class="form-control form-control-user" name="fornecedor_nome_fantasia"
									   value="<?php echo $fornecedor->fornecedor_nome_fantasia; ?>">
					...
					<fieldset class="mt-4 border p-2">
						<legend class="font-small"><i class="fas fa-map-marker-alt">&nbsp; Contato </i></legend>
						...
						<div class="form-group row mb-3">
							...
							<div class="col-md-4">
								...
								<input type="text" class="form-control form-control-user" name="fornecedor_telefone"
									   value="<?php echo $fornecedor->fornecedor_telefone; ?>">
							...
							<div class="col-md-4">
								...
								<input type="text" class="form-control form-control-user" name="fornecedor_email"
									   value="<?php echo $fornecedor->fornecedor_email; ?>">
							...
							<div class="col-md-4">
								...
								<input type="text" class="form-control form-control-user" name="fornecedor_endereco"
									   value="<?php echo $fornecedor->fornecedor_endereco; ?>">
						...
						<div class="form-group row mb-3">
							...
							<div class="col-md-4">
								...
								<input type="text" class="form-control form-control-user" name="fornecedor_bairro"
									   value="<?php echo $fornecedor->fornecedor_bairro; ?>">
							...
							<div class="col-md-4">
								...
								<input type="text" class="form-control form-control-user" name="fornecedor_cidade"
									   value="<?php echo $fornecedor->fornecedor_cidade; ?>">
							...
							<div class="col-md-4">
								...
								<input type="text" class="form-control form-control-user" name="fornecedor_complemento"
									   value="<?php echo $fornecedor->fornecedor_complemento; ?>">
						...
						<div class="form-group row">
							...
							<div class="col-md-8">
								...
								<textarea class="form-control form-control-user"
										  name="fornecedor_obs"><?php echo $fornecedor->fornecedor_obs; ?></textarea>
