	...
	<div class="container-fluid">
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				...
				<!-- Botão -->
				<a title="Cadastrar novo cliente" href="<?php echo base_url('clientes/add'); ?>" class="btn btn-success btn-sm float-right"><i
							class="fas fa-user-tie"></i>&nbsp;Novo</a>
					...
					<table class="table table-bordered dataTable " width="100%" cellspacing="0">
						...
						<?php foreach ($clientes as $cliente): ?>
							...
							<tr>
								...
								<td> <?php echo $cliente->cliente_bairro ?></td>
								<td> <?php echo ($cliente->cliente_tipo == 1 ? 'Pessoa fisica' : 'Pessoa jurídica') ?></td>
								...
								<!-- Operações -->
								<td class="text-right">
									<a title="Editar" href="<?php echo base_url('clientes/edit/' . $cliente->cliente_id); ?>"
									   class="btn btn-sm btn-primary"><i class="fas fa-user-edit"></i></a>
									<a title="Excluir " href="javascript(void)" data-toggle="modal" data-target="#cliente-<?php echo $cliente->cliente_id;?>" class="btn btn-sm btn-danger"><i
